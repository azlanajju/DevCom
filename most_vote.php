...
$sql = "SELECT qna.id, qna.UserID, Users.Name AS UserName, qna.questionTitle, qna.problemDetails, qna.answerExpectations, qna.tags, qna.askedTime, qna.updatedTime, qna.upvote, qna.downvote,
        COUNT(a.id) AS answerCount, SUM(a.upvote) + SUM(a.downvote) AS voteCount
        FROM qna
...
<!-- motto start  -->
<div class="content">
    <h1>Share &amp; grow the knowledge!</h1>
    <p>
      We want to connect the people who have knowledge to the people who need
      it, to bring together people with different perspectives so they can
...
<div onclick="openNav()" class="menu-bars">
  ...
  <div id="navPhone" class="navside">
    ...
    <ul>
      ...
      <li>
        <a class="sidelink" href="/community">
...
<?php   echo $phoneauth; ?>
  ...
  <div class="middle-nav-menu">
    <ul>
      ...
      <li>
        <a href="#" class="menu-link active">Most Voted</a>
      </li>
      <li>
